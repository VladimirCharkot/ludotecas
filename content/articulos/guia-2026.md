...
Este artículo está acompañado por nuestro [tríptico "Cómo armar una Ludoteca en tu escuela"](https://drive.google.com/file/d/1P7042YlGUzAZR6TygjvauxskGnXN25-t/view), un pequeño recetario con los primeros pasos para poner en marcha tu ludoteca.
...
¡Hola! Orgullosísimas de la cantidad de escuelas participando del programa, y en línea con las preguntas frecuentes que van llegando, les compartimos **algunas referencias para pensar las ludotecas en el marco del programa[^2]**.

En este artículo:

- [**Derecho al juego**](#derecho-al-juego): encuadre de valoración del juego como derecho.
- [**Es en y con la comunidad**](#comunidad): juegotecas escolares abiertas a la comunidad.
...
El programa se posiciona como punto de aplicación de este principio consagrado en la Convención sobre los Derechos del Niño y en la ley de Educación n° 26.206, que reconoce al Juego por su valor cultural y promotor del desarrollo cognitivo, afectivo, motor y social[^3].
...
Nuestro programa se inscribe en el marco de las políticas educativas con enfoque de bienestar de la provincia[^5], de cuyos principios orientadores recuperamos especialmente:
...
El modelo de Recreación Educativa propuesto por Pablo Waichman[^6], en línea con estos principios, propone una acción planificada, con objetivos y actividades que busquen **la participación de las personas desde sus intereses y posibilidades**, con la finalidad de la toma de conciencia y la construcción de la propia libertad y la del colectivo[^7].
...
En concreto, los ingredientes que de hecho _supone_ la ludoteca son[^9]:
...
Desde aquí podemos rescatar también el término _dispositivo lúdico_, corriendo el pre-supuesto de que todos los elementos de la ludoteca han de calificar de _juego_. Puede que traigamos un enorme bagaje de experiencias en actividades que sin llegar a ser juegos contienen el espíritu lúdico, como muchas del universo de artes, prácticas corporales y expresivas, plástica, manualidades, oficios, artesanías, etc. ¡Estas cuentan!
...
[^2]: Programa Ludotecas (Subdirección de Participación, Derechos y Comunidad, Ministerio de Educación de la Provincia de Córdoba). _Marco teórico de la línea de Ludotecas y dispositivos lúdicos_. Documento disponible en la portada de este sitio y en [drive.google.com](https://drive.google.com/file/d/1hv0nVWmp5prA7Izu1ZP_FtX0I3cDwngC/view?usp=sharing)
[^3]: Ley de Educación Nacional n° 26206. (2006), art. 20. Documento disponible en [argentina.gob.ar](https://www.argentina.gob.ar/sites/default/files/ley-de-educ-nac-58ac89392ea4c.pdf)
[^4]: Proyecto de Ley Nacional de Recreación (2022), Fundamentos. Expediente 1423-D-2022, Honorable Cámara de Diputados de la Nación. Documento disponible en [hcdn.gob.ar](https://www4.hcdn.gob.ar/dependencias/dsecretaria/Periodo2022/PDF2022/TP2022/1423-D-2022.pdf)
[^5]: Ministerio de Educación de la Provincia de Córdoba, Dirección General de Bienestar Educativo. _BienCBA. Políticas educativas con enfoque de bienestar_. Documento disponible en [igualdadycalidadcba.gov.ar](https://www.igualdadycalidadcba.gov.ar/SIPEC-CBA/SFI/DGBE/doc/biencba.pdf)
[^6]: Pablo Waichman (2004), Tiempo libre y recreación. Un desafío pedagógico. Ediciones Pablo Waichman.
[^7]: Este modelo, al decir de Griffa y Nakayama (2024, pág.8)[^8] “toma al juego y a la lúdica como elementos dinamizadores de procesos grupales en pos del protagonismo, la autonomía y el desarrollo de la libertad en el tiempo”.
[^8]: Griffa, M. y Nakayama, L. (2024). Clase 2: Introducción a la recreación. Paradigmas y Debates Actuales en el Campo de la Recreación. Especialización en Recreación y Juego. Facultad de Educación Física Ipef. Universidad Provincial de Córdoba.
[^9]: [Cómo armar una ludoteca en tu escuela](https://drive.google.com/file/d/1P7042YlGUzAZR6TygjvauxskGnXN25-t/view), documento armado por nuestro programa y disponible en la portada de este sitio.
[^10]: SEDRONAR (2018). Jugadas. Adolescencia y juventudes ni puestas ni sacadas, p.139.

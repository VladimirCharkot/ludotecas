---
titulo: Go-lazo
descripcion: ¡Llega el Go a las escuelas de Córdoba!
---

![Ilustración de público explotando de entusiasmo durante el desafío de Lee Sedol y AlphaGo](/assets/go-lazo/go-lazo-portada.webp)

¡Con mucha alegría y entusiasmo innauguramos este 2026 **la línea de Go** dentro del programa!
...
El Go se caracteriza por una **simpleza de reglas y una profundidad estratégica singulares**. Diríamos que con el tiempo enseña lecciones sin usar palabras. Durante la partida, los jugadores van colocando fichas –llamadas "piedras"– por turnos, fortaleciendo sus posiciones en el territorio mediante su capacidad de rodear al adversario en caso de que decida invadir. La propuesta del juego no es acabar con el rival sino crecer tanto como sea posible. Porque contamos puntos al final generalmente decimos que gana quien más puntos tiene, pero es perfectamente posible **jugar una partida de Go, observar el tablero al final y leerlo como una historia**, con momentos, giros, tramas, nudos y desenlaces, más que como un resultado.

Con la práctica y las partidas, la jugadora o jugador va formándose modelos cada vez más generales de dónde jugar cada piedra y por qué. Un proverbio clásico del Go condensa bien esa lógica de aprendizaje: "perdé tus primeras 50 partidas lo más rápido posible". **Al principio no aprendemos jugando bien sino jugando mucho**: perdiendo rápido, leyendo por qué salió como salió, y volviendo a sentarse al tablero. Es la misma lógica de ensayo y error con la que se aprende a decidir en cualquier ámbito de la vida —no leyendo sobre decisiones, sino tomándolas, jugando el juego y viendo qué sale.

Esta transferencia no es solo una sensación de quienes juegan: en Corea, donde el Go tiene fuerte presencia cultural, **se lo usó como intervención terapéutica** en chicos con TDAH, **con mejoras medibles** en atención y función ejecutiva, y en personas mayores con deterioro cognitivo leve, con mejoras en su función cognitiva general[^2].
...
> El punto clave del contrincante es el tuyo
>
> – Proverbio del Go

Te proponemos empezar a jugar y agarrarle un poco la mano antes de llevarlo al aula. Acá te contamos cómo empezar:

### Cómo hacer un tablero

El tablero y las fichas son muy sencillos de fabricar en casa. Podemos dibujar el tablero en una hoja, una placa de madera o pintarlo sobre un lienzo o trozo de tela; en tela funciona muy bien para guardar enrollado. Pueden reutilizarse fichas de TEG o algún otro juego, o armarlas en cerámica o porcelana fría, son simples fichas chatas circulares blancas y negras.

El tablero de competición tiene una grilla de 19x19 líneas, pero para el aula recomendamos arrancar con tableros más chicos —9x9 y 13x13— que acortan las partidas y hacen mucho más llevadero el aprendizaje de las primeras nociones. Típicamente los juegos llevan fichas suficientes para cubrir todo el tablero, mitad de cada color, y una ficha extra de color negro, que arranca la partida. En números: 181 negras / 180 blancas para 19x19, 85 negras / 84 blancas para 13x13, 41 negras / 40 blancas para 9x9).

¡Atenti a dibujar la cantidad de **líneas** correctas! Nos suele pasar que al dibujar un tablero contamos los espacios, y terminamos dibujando una línea de más.

No hace falta nada más para jugar.

![Tableros de 9, 13 y 19 líneas](/assets/go-lazo/tableros.webp)
...
En la siguiente imágen pueden verse 4 casos de piedras en atari. Si blanco juega en los puntos marcados, captura las piedras negras.
...
La forma más habitual de enseñar Go, sobre todo a chicas y chicos, no es con el juego completo sino con una variante llamada **Atari Go**: se juega igual, pero gana quien primero captura cualquier grupo rival, sin territorio ni conteo de por medio. Es una manera muy directa de entender la mecánica del rodear, las libertades y el atari antes de meterse con el juego completo.

![Ilustración de mano colocando piedra de Go en tablero](/assets/go-lazo/arte-2.webp)

## Los elementos

> Una serpiente con dos ojos es inmortal
> – Proverbio del Go

De esas pocas reglas se desprenden, casi como consecuencia lógica, un puñado de nociones que no están escritas en ningún lado pero que se terminan incorporando con la práctica.
...
Por contraste, en la siguiente imágen hay dos escenarios de **cadenas muertas**.

En la esquina superior izquierda la piedra blanca está muerta: si blanco juega allí otra piedra se queda con una sola libertad y negro responde capturando ambas juntas.

Por otro lado, en la derecha, tenemos un grupo blanco que no puede formar dos ojos. Es cuestión de trámite para negro capturar la cadena blanca. Y si blanco intentara capturar la piedra negra, se quedaría con una sola libertad (donde ahora está esa piedra negra), y por lo tanto negro capturaría al turno siguiente. Si blanco hubiera jugado en ese punto en lugar de negro, tendría una cadena inmortal (3 ojos en este caso).

![Cadenas muertas](/assets/go-lazo/piedras-muertas.webp)
...
Con la práctica y el tiempo se va afinando la intuición sobre dimensiones más estratégicas, que empiezan a pensarse como conceptos independientes: la **conectividad y la velocidad**, el **balance entre territorio e influencia**, la **iniciativa** (jugar en "sente", sin ceder el ataque), la eficiencia de forma de las piedras, **aperturas** ("fuseki") y **secuencias de esquina** ("joseki") típicas. No hace falta conocerlas de entrada — van apareciendo solas a medida que se juega más.

La mejor manera de arrancar, de todos modos, es jugando. Y ahí el universo digital tiene una ventaja enorme: encontrás rival al instante, sin necesitar que nadie más en tu entorno sepa jugar, y la mayoría de las plataformas tiene tutoriales interactivos y problemas para practicar. A continuación, algunos puntos de partida.

## Dónde aprender y jugar online

Te dejamos algunos recursos web para que puedas experimentar ya mismo.

- [go.org.ar](https://go.org.ar/) - Web de la Asociación Argentina de Go. Ofrecen recursos de aprendizaje, actividades, clases, índices de clubes locales y más. Tienen una sección de [primeros pasos](https://go.org.ar/index.php/primeros-pasos).
- [ludidactas.com](https://ludidactas.com/) - Aplicación web específicamente para docentes, que permite crear una sala donde tus estudiantes pueden jugar al Go online sin registrarse ni exponerse.
- [online-go.com](https://online-go.com/) - Aplicación web masiva, abierta e internacional, bien conocida, con muchísimos recursos de aprendizaje y trabajo de curaduría aportados por la comunidad, aunque mayormente en inglés. Para jugar online hay que registrarse y las partidas tienen chats. Puede ser muy abrumador para alguien que está empezando y expuesto para la escuela. Es donde se va a perfeccionarse y participar de rankings internacionales.
...
> No sigas proverbios ciegamente
>
> – Proverbio del Go

Como con cualquier juego, **la mejor forma de prepararte para llevarlo al aula es jugarlo vos primero**: sentate a jugar unas partidas —incluso perdiendo las primeras cincuenta— e ir descubriendo de primera mano todo lo que hay debajo de estas pocas reglas. Hay mucho más de lo que cabe en esta página, y se sigue descubriendo con la práctica.

Por ahora esta es la acción propuesta desde el programa: **prepararnos jugando y llevarlo activamente a nuestras aulas y ludotecas**. No necesita traducirse la inteligencia que el juego ya fomenta, ni redundar en alguna evidencia específica.

Si te surge alguna duda en el camino, o querés contarnos cómo te fue llevándolo al aula, escribinos a ludotecaseducacion.cba@gmail.com. Mirá que vamos a estar esperando tu mail.

Gracias por llegar hasta, ¡te esperamos para jugar alguna partida!

[^1]: [British Go Association - A Brief History of Go](https://www.britgo.org/intro/history)
[^2]: [Kim et al. (2014), "Baduk (the Game of Go) Improved Cognitive Function and Brain Activity in Children with Attention Deficit Hyperactivity Disorder"](https://pmc.ncbi.nlm.nih.gov/articles/PMC4023088/) y [Iizuka et al. (2018), "Pilot Randomized Controlled Trial of the GO Game Intervention on Cognitive Function"](https://journals.sagepub.com/doi/10.1177/1533317517753362)
[^3]: [Zen stories to tell your neighbors](https://vedantabharata.wordpress.com/2017/09/08/john-sulers-zen-stories-to-tell-your-neighbors/)
[^4]: [Infobae (2022), "Go, el juego de estrategia chino que Confucio consideraba virtuoso y que tendrá un congreso en Argentina"](https://www.infobae.com/sociedad/2022/10/04/go-el-juego-de-estrategia-chino-que-confucio-consideraba-virtuoso-y-que-tendra-un-congreso-en-argentina/), [Infobae (2024), "Los chicos argentinos que viajan a China a jugar un Mundial de Go"](https://www.infobae.com/sociedad/2024/11/05/los-chicos-argentinos-que-viajan-a-china-a-jugar-un-mundial-de-go-tenemos-al-messi-de-este-juego-en-el-equipo/) y [American Go Association, "Interview: Fernando Aguilar on Fifty Years of Go, Strategy, and Joy"](https://www.usgo.org/content.aspx?page_id=5&club_id=454497&item_id=127298)
[^5]: [Interview: Fernando Aguilar on Fifty Years of Go, Strategy, and Joy](https://www.usgo.org/content.aspx?page_id=5&club_id=454497&item_id=127298)
[^6]: Su libro "Elementos del Go", editado y distribuído por la Asociación, es el hilo conductor de nuestro acercamiento pedagógico, y se encuentra disponible como colección de artículos en pdf en la [página de material de estudio de la AAGo](https://go.org.ar/index.php/contenido/material-de-estudio)

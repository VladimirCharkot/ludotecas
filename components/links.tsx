...
const links = [
  {
    ...
    descripcion: "Conoce el mazo de naipes con propuestas lúdicas que hemos creado para la conmemoración de los 50 años del golpe cívico-militar en Argentina",
  ...
  },
  {
    ...
    descripcion: "Conoce los videojuegos que hemos propuesto en nuestro mazo de cartas",
  ...
  // },
  {
    ...
    descripcion: "Hechizo Ludotecario para que tu comunidad pueda realizar su propia Ludoteca",
    imagen: "/LogoCartas.png"
  },
  {
    label: "Institucional - Ludotecas, Ajedrez y Go",
    url: "http://www.igualdadycalidadcba.gov.ar/SIPEC-CBA/SFI/DGBE/SPDyC/ludotecas.php",
    descripcion: "Conoce el espacio institucional del Programad de Ludotecas, Ajedrez y Go",
